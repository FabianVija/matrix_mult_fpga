...
HD_PWD='/home/fabian/Documents/ensta/deuxieme/sys_elec_embar/Zynq_Book/adventures_with_ip/adventures_with_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_wrapper.tcl
