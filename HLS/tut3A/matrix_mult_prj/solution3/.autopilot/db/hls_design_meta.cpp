...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("a_address1", 5, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("a_ce1", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("a_q1", 8, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("b_address1", 5, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("b_ce1", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("b_q1", 8, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("prod_address0", 5, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("prod_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("prod_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("prod_d0", 16, hls_out, 2, "ap_memory", "mem_din", 1),
};
