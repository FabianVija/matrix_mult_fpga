...
set C_modelArgList {
	...
	{ b int 8 regular {array 25 { 1 1 } 1 1 }  }
...
set ArgLastReadFirstWriteLatency {
	matrix_mult {
		...
		prod {Type O LastRead -1 FirstWrite 10}}}
...
set Spec2ImplPortList { 
	...
	b { ap_memory {  { b_address0 mem_address 1 5 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 8 }  { b_address1 mem_address 1 5 }  { b_ce1 mem_ce 1 1 }  { b_q1 mem_dout 0 8 } } }
