...
if {[file isfile matrix_mult.autotvin.dat]} {
	file delete -force matrix_mult.autotvin.dat
}

if {[file isfile matrix_mult.autotvout.dat]} {
	file delete -force matrix_mult.autotvout.dat
}
